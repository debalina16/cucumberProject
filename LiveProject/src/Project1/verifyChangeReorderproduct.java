 ...
 *
 */
public class verifyChangeReorderproduct {
	private WebDriver d;
	...
	@Test
	public void testEight() throws Throwable {
		...
		/* Click on Reorder */
		d.findElement(By.xpath("//tr[@class='first odd']/td/span/a[text()='Reorder']")).click();

		/* Change Quality and click on Update */
		d.findElement(By.xpath("//input[@class='input-text qty']")).clear();
		d.findElement(By.xpath("//input[@class='input-text qty']")).sendKeys("10");
		d.findElement(By.xpath("//button[@class='button btn-update']/span")).click();
		...
		String totalPrice = d.findElement(By.xpath("//table[@id='shopping-cart-totals-table']/tbody/tr[1]/td[2]/span"))
				.getText();
		String totShippingCost = d
				.findElement(By.xpath("//table[@id='shopping-cart-totals-table']/tbody/tr[2]/td[2]/span")).getText();
		String GrandTotal = d.findElement(By.xpath("//strong[text()='Grand Total']/../../td[2]")).getText();

		int grandTotalPrice = (((Integer.parseInt(totalPrice.replaceAll("[\\$\\,\\.]", ""))
				+ (Integer.parseInt(totShippingCost.replaceAll("[\\$\\,\\.]", ""))))) / 100);

		int grandTot = (Integer.parseInt(GrandTotal.replaceAll("[\\$\\,\\.]", "")) / 100);

		try {
			Assert.assertEquals((grandTotalPrice), (grandTot));
			System.out.println("Grand Price is verified:" + GrandTotal + " ====>Pass");
		} catch (Exception e) {
			System.out.println("Grand Price is not verified:" + GrandTotal + " ====>Fail");
		}
		...
		String shippingTot = d
				.findElement(By.xpath("//tr/td[contains(text(),'Shipping & Handling (Flat Rate - Fixed)')]/../td[2]"))
				.getText();
		String grandTotal = d.findElement(By.xpath("//tr[@class='last']/td[@class='a-right last']")).getText();
		System.out.println("Shipping Price:" + shippingTot + " and Grand Total:" + grandTotal);
