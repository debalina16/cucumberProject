...
public String getPropertyKeyValue(String key) throws Throwable {
	FileInputStream fis=new FileInputStream("E:\\Git\\Maven_Actitime\\src\\test\\resources\\commonData.properties");
...
public String getExcelData(String sheetName,int rowNum,int celNum) throws Throwable {
	FileInputStream fis=new FileInputStream("E:\\Git\\Maven_Actitime\\src\\test\\resources\\Tools.xlsx");
...
public void setExcelData(String sheetName,int rowNum,int celNum,String data) throws Throwable {
	...
	FileOutputStream fos=new FileOutputStream("E:\\Git\\Maven_Actitime\\src\\test\\resources\\Tools.xlsx");
	wb.write(fos);
	wb.close();
 }
}
